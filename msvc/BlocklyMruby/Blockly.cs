...
public partial class Blockly
{
	...
	public WorkspaceSvg inject(Any<string, Element> container, object opt_options = null)
	{
	...
	public Any<string, int> tokenizeInterpolation(string message)
	{
...
public class FieldDropdown : Field
{
	...
	/// </param>
	public FieldDropdown(Blockly blockly, Any<string[][], Func<string[][]>> menuGenerator, Func<string, object> opt_validator = null)
		: base(blockly, null)
	{
...
public class FieldNumber : FieldTextInput
{
	...
	/// text as an argument and returns either the accepted text, a replacement
	/// text, or null to abort the change.</param>
	public FieldNumber(Blockly blockly, string value, Any<string, int> opt_min,
...
public static class goog
{
	...
	{
		public static Element createDom(BlocklyScript Script, string v, object o = null, Any<string, Element> t = null)
		{
