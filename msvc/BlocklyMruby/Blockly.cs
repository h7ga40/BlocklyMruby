...
namespace BlocklyMruby
{
	...
	public partial class Blockly
	{
		...
		[Name(false), FieldProperty]
		public Procedures Procedures { get; private set; }
		[Name(false), FieldProperty]
		public Variables Variables { get; private set; }
		[Name(false), FieldProperty]
		public Names Names { get; private set; }

		public Blockly(BlocklyScript script, object instance)
		{
		...
		/// </summary>
		[Name(false), FieldProperty]
		public int DRAG_RADIUS { get { return instance.DRAG_RADIUS; } }

		/// <summary>
		/// Maximum misalignment between connections for them to snap together.
		/// </summary>
		[Name(false), FieldProperty]
		public int SNAP_RADIUS { get { return instance.SNAP_RADIUS; } }

		/// <summary>
		/// Delay in ms between trigger and bumping unconnected block out of alignment.
		/// </summary>
		[Name(false), FieldProperty]
		public int BUMP_DELAY { get { return instance.BUMP_DELAY; } }

		/// <summary>
		/// Number of characters to truncate a collapsed block to.
		/// </summary>
		[Name(false), FieldProperty]
		public int COLLAPSE_CHARS { get { return instance.COLLAPSE_CHARS; } }

		/// <summary>
		/// Length in ms for a touch to become a long press.
		/// </summary>
		[Name(false), FieldProperty]
		public int LONGPRESS { get { return instance.LONGPRESS; } }
		...
		/// </summary>
		[Name(false), FieldProperty]
		public int SOUND_LIMIT { get { return instance.SOUND_LIMIT; } }
		...
		/// </summary>
		[Name(false), FieldProperty]
		public double HSV_SATURATION { get { return instance.HSV_SATURATION; } }
		...
		/// </summary>
		[Name(false), FieldProperty]
		public double HSV_VALUE { get { return instance.HSV_VALUE; } }

		/// <summary>
		/// Sprited icons and images.
		/// </summary>
		[Name(false), FieldProperty]
		public object SPRITE { get { return instance.SPRITE; } }

		/// <summary>
		/// Required name space for SVG elements.
		/// </summary>
		[Name(false), FieldProperty]
		public string SVG_NS { get { return instance.SVG_NS; } }

		/// <summary>
		/// Required name space for HTML elements.
		/// </summary>
		[Name(false), FieldProperty]
		public string HTML_NS { get { return instance.HTML_NS; } }

		/// <summary>
		/// ENUM for a right-facing value input.  E.g. 'set item to' or 'return'.
		/// </summary>
		[Name(false), FieldProperty]
		public int INPUT_VALUE { get { return instance.INPUT_VALUE; } }

		/// <summary>
		/// ENUM for a left-facing value output.  E.g. 'random fraction'.
		/// </summary>
		[Name(false), FieldProperty]
		public int OUTPUT_VALUE { get { return instance.OUTPUT_VALUE; } }

		/// <summary>
		/// ENUM for a down-facing block stack.  E.g. 'if-do' or 'else'.
		/// </summary>
		[Name(false), FieldProperty]
		public int NEXT_STATEMENT { get { return instance.NEXT_STATEMENT; } }

		/// <summary>
		/// ENUM for an up-facing block stack.  E.g. 'break out of loop'.
		/// </summary>
		[Name(false), FieldProperty]
		public int PREVIOUS_STATEMENT { get { return instance.PREVIOUS_STATEMENT; } }

		/// <summary>
		/// ENUM for an dummy input.  Used to add field(s) with no input.
		/// </summary>
		[Name(false), FieldProperty]
		public int DUMMY_INPUT { get { return instance.DUMMY_INPUT; } }

		/// <summary>
		/// ENUM for left alignment.
		/// </summary>
		[Name(false), FieldProperty]
		public int ALIGN_LEFT { get { return instance.ALIGN_LEFT; } }

		/// <summary>
		/// ENUM for centre alignment.
		/// </summary>
		[Name(false), FieldProperty]
		public int ALIGN_CENTRE { get { return instance.ALIGN_CENTRE; } }

		/// <summary>
		/// ENUM for right alignment.
		/// </summary>
		[Name(false), FieldProperty]
		public int ALIGN_RIGHT { get { return instance.ALIGN_RIGHT; } }

		/// <summary>
		/// ENUM for no drag operation.
		/// </summary>
		[Name(false), FieldProperty]
		public int DRAG_NONE { get { return instance.DRAG_NONE; } }

		/// <summary>
		/// ENUM for inside the sticky DRAG_RADIUS.
		/// </summary>
		[Name(false), FieldProperty]
		public int DRAG_STICKY { get { return instance.DRAG_STICKY; } }
		...
		/// </summary>
		[Name(false), FieldProperty]
		public int DRAG_BEGIN { get { return instance.DRAG_BEGIN; } }

		/// <summary>
		/// ENUM for freely draggable (outside the DRAG_RADIUS, if one applies).
		/// </summary>
		[Name(false), FieldProperty]
		public int DRAG_FREE { get { return instance.DRAG_FREE; } }

		/// <summary>
		/// Lookup table for determining the opposite type of a connection.
		/// </summary>
		[Name(false), FieldProperty]
		public int[] OPPOSITE_TYPE { get { return instance.OPPOSITE_TYPE; } }

		/// <summary>
		/// ENUM for toolbox and flyout at top of screen.
		/// </summary>
		[Name(false), FieldProperty]
		public int TOOLBOX_AT_TOP { get { return instance.TOOLBOX_AT_TOP; } }

		/// <summary>
		/// ENUM for toolbox and flyout at bottom of screen.
		/// </summary>
		[Name(false), FieldProperty]
		public int TOOLBOX_AT_BOTTOM { get { return instance.TOOLBOX_AT_BOTTOM; } }

		/// <summary>
		/// ENUM for toolbox and flyout at left of screen.
		/// </summary>
		[Name(false), FieldProperty]
		public int TOOLBOX_AT_LEFT { get { return instance.TOOLBOX_AT_LEFT; } }

		/// <summary>
		/// ENUM for toolbox and flyout at right of screen.
		/// </summary>
		[Name(false), FieldProperty]
		public int TOOLBOX_AT_RIGHT { get { return instance.TOOLBOX_AT_RIGHT; } }

		/// <summary>
		/// The main workspace most recently used.
		/// Set by WorkspaceSvg.prototype.markFocused
		/// </summary>
		[FieldProperty]
		public WorkspaceSvg mainWorkspace { get { return WorkspaceSvg.Create(this, instance.mainWorkspace); } }

		/// <summary>
		/// Currently selected block.
		/// </summary>
		[FieldProperty]
		public Block selected { get { return Script.CreateBlock(instance.selected); } }

		[Name(false), FieldProperty]
		public object Blocks { get { return instance.Blocks; } }
		...
		internal void registerButtonCallback(string key, Action<FlyoutButton> func)
		{
			instance.registerButtonCallback.call(instance, key, Script.NewFunc(new Action<object>((btn) => {
				func(FlyoutButton.Create(this, btn));
			})));
		}
		...
		public string hueToRgb(int hue)
		{
		...
		public goog.math.Size svgSize(Element svg)
		{
		...
		public void resizeSvgContents(WorkspaceSvg workspace)
		{
		...
		public void svgResize(WorkspaceSvg workspace)
		{
		...
		public void hideChaff(bool opt_allowToolbox = false)
		{
		...
		public WorkspaceSvg getMainWorkspace()
		{
		...
		internal void alert(string message, Action opt_callback = null)
		{
		...
		internal void prompt(string message, string defaultValue, Action<string> callback)
		{
		...
		public WorkspaceSvg inject(Union<string, Element> container, object opt_options = null)
		{
			var element = container.As<Element>();
			if (element != null)
				return WorkspaceSvg.Create(this, instance.inject.call(instance, element.instance, opt_options));
			else
				return WorkspaceSvg.Create(this, instance.inject.call(instance, container.Value, opt_options));
		}
		...
		public void updateToolbox(Union<Node, string> tree)
		{
		...
		public Element createSvgElement(string name, object attrs, Element parent, Workspace opt_workspace)
		{
		...
		public bool isRightButton(Event e)
		{
		...
		public goog.math.Coordinate mouseToSvg(Event e, Element svg, SVGMatrix matrix)
		{
		...
		public int shortestStringLength(string[] array)
		{
		...
		public int commonWordPrefix(string[] array, int opt_shortest = 0)
		{
			return instance.commonWordPrefix.call(instance, Bridge.Script.NewArray(array), opt_shortest);
		}
		...
		public int commonWordSuffix(string[] array, int opt_shortest = 0)
		{
			return instance.commonWordSuffix.call(instance, Bridge.Script.NewArray(array), opt_shortest);
		}
		...
		public Union<string, int> tokenizeInterpolation(string message)
		{
		...
		/// <returns></returns>
		public string wrap(string text, int wrap)
		{
	...
	public class Xml
	{
		BlocklyScript Script;

		public Xml(Blockly Blockly)
		{
		...
		public Element workspaceToDom(Workspace workspace)
		{
			return Element.Create(Script, Script.XmlWorkspaceToDom(workspace.instance));
		}
		...
		public Element blockToDomWithXY(Block block)
		{
			return Element.Create(Script, Script.XmlBlockToDomWithXY(block.instance));
		}
		...
		/// <param name="block">The root block to encode.</param>
		/// <returns>Tree of XML elements.</returns>
		public Element blockToDom(Block block)
		{
			return Element.Create(Script, Script.XmlBlockToDom(block.instance));
		}
		...
		public string domToText(Element dom)
		{
		...
		/// <param name="dom">A tree of XML elements.</param>
		/// <returns>Text representation.</returns>
		public string domToPrettyText(Element dom)
		{
		...
		public Element textToDom(string text)
		{
			return Element.Create(Script, Script.XmlTextToDom(text));
		}
		...
		public void domToWorkspace(Element xml, Workspace workspace)
		{
		...
		public Block domToBlock(Element xmlBlock, Workspace workspace)
		{
		...
		/// </summary>
		/// <param name="xmlBlock">XML block element.</param>
		public void deleteNext(Element xmlBlock)
		{
	...
	{
		internal dynamic instance;
		internal Blockly Blockly;
		internal BlocklyScript Script;

		[FieldProperty]
		public string id { get { return instance.id; } }
		[FieldProperty]
		public Options options { get { return new Options(Blockly, instance.options); } }
		[Name(false), FieldProperty]
		...
		protected Workspace(Blockly Blockly, object instance)
		{
			this.instance = instance;
		...
		public static Workspace Create(Blockly Blockly, Options opt_options = null)
		{
			var Script = Blockly.Script;
			var instance = Script.New("Blockly.Workspace", new object[] { opt_options != null ? opt_options.instance : null });
			return new Workspace(Blockly, instance);
		}
		...
		Dictionary<object, Action<Abstract>> Listeners = new Dictionary<object, Action<Abstract>>();
		...
		public void removeChangeListener(Action<Abstract> func)
		{
			object _func = null;
		...
		public void fireChangeListener(Abstract @event)
		{
	...
	{
		public WorkspaceSvg(Blockly Blockly, object instance)
			: base(Blockly, instance)
		{
		}

		internal static WorkspaceSvg Create(Blockly Blockly, dynamic workspace)
		{
			...
			var ret = new WorkspaceSvg(Blockly, workspace);
		...
		{
			return Element.Create(Script, instance.createDom.call(instance, opt_backgroundClass));
		}
		...
		{
			return new BlockSvg(Blockly, instance.newBlock.call(instance, prototypeName, opt_id));
		}
	...
	public class Events
	{
		...
		public string[] getDescendantIds_(Block block)
		{
		...
		internal void fire(Abstract ev)
		{
	...
	public class Abstract
	{
		...
		/// <summary>
		/// UUID of workspace. The workspace can be found with Workspace.getById(event.workspaceId)
		/// </summary>
		[Name(false), FieldProperty]
		...
		/// </summary>
		[Name(false), FieldProperty]
		internal string blockId { get { return Script.Get(instance, "blockId"); } }
		...
		public Abstract(Blockly Blockly, object instance)
		{
			this.instance = instance;
			this.Blockly = Blockly;
			Script = Blockly.Script;
	...
	public class Create : Abstract
	{
		...
		internal Element xml {
			get { return Element.Create(Script, instance.xml); }
		...
		public Create(Blockly Blockly, object instance)
			: base(Blockly, instance)
		{
		}
		...
		{
			instance = Script.New("Blockly.Events.Create", new object[] { block, Events.CREATE });
			if (block == null) {
	...
	public class Delete : Abstract
	{
		...
		internal Element oldXml {
			get { return Element.Create(Script, instance.oldXml); }
		...
		public Delete(Blockly Blockly, object instance)
			: base(Blockly, instance)
		{
		}
		...
		public void construct(Block block)
		{
			instance = Script.New("Blockly.Events.Delete", new object[] { block, Events.DELETE });
	...
	public class Change : Abstract
	{
		...
		public Change(Blockly Blockly, object instance)
			: base(Blockly, instance)
		{
		}
		...
		{
			var instance = block.Script.New("Blockly.Events.Change", new object[] { block.instance, Events.CHANGE });
			if (block == null) {
			...
			return new Change(block.Blockly, instance);
		}
	}
	...
	public class Move : Abstract
	{
		...
		public Move(Blockly Blockly, object instance)
			: base(Blockly, instance)
		{
		}
		...
		public void construct(Block block)
		{
			var instance = block.Script.New("Blockly.Events.Move", new object[] { block, Events.MOVE });
			if (block == null) {
				return;  // Blank event to be populated by fromJson.
			}
			var location = currentLocation_();
		...
		{
			return new Location(Script, instance.currentLocation_.call(instance));
		}
	}
	...
	public class Ui : Abstract
	{
		...
		public Ui(Blockly Blockly, object instance)
			: base(Blockly, instance)
		{
		}
		...
		{
			instance = Script.New("Blockly.Events.Ui", new object[] { block, Events.UI });
			instance.element = element;
			instance.oldValue = oldValue;
			instance.newValue = newValue;
		}
	...
	public class Options
	{
		...
		public Node languageTree { get { return new Node(Script, instance.languageTree); } }
		public bool oneBasedIndex { get { return instance.oneBasedIndex; } }
		public Workspace parentWorkspace { get { return WorkspaceSvg.Create(Blockly, instance.parentWorkspace); } }
		public bool comments { get { if (Bridge.Script.HasMember(instance, "comments")) return instance.comments; else return false; } }

		public Options(Blockly Blockly, object instance)
		{
			this.instance = instance;
			this.Blockly = Blockly;
			Script = Blockly.Script;
	...
	{
		[Name(false)]
		public int TAB_HEIGHT = 20;

		public BlockSvg(Blockly blockly, string type)
			: base(blockly, type)
		{
		}
	}
	...
	{
		public Comment(Blockly Blockly, object instance)
			: base(Blockly, instance)
		{
			this.instance = instance;
		}
	...
	public class Input
	{
		...
		public Connection connection { get { return Connection.Create(Blockly, instance.connection); } }
		public FieldList fieldRow {
			get {
				return new FieldList(Script, instance.fieldRow);
			}
		}

		public Input(Blockly Blockly, object instance)
		{
			this.instance = instance;
			this.Blockly = Blockly;
			Script = Blockly.Script;
		...
		public Input appendField(Union<string, Field> field, string opt_name = null)
		{
		...
		{
			return new BlockList(Script, instance.setVisible.call(instance, visible));
		}
		...
		public Input setCheck(Union<string, string[]> check)
		{
			...
			if (chk != null)
				return Script.CreateInput(instance.setCheck.call(instance, Bridge.Script.NewArray(check)));
			else
	...
	public class Icon
	{
		...
		public Icon(Blockly Blockly, object instance)
		{
			this.instance = instance;
			this.Blockly = Blockly;
			Script = Blockly.Script;
	...
	{
		public Workspace workspace_ { get { return WorkspaceSvg.Create(Blockly, instance.workspace_); } }
		...
		protected Mutator(Blockly Blockly, object instance)
			: base(Blockly, instance)
		{
		}

		internal static Mutator Create(Blockly Blockly, object mutator)
		{
			...
			var ret = new Mutator(Blockly, mutator);
			Script.Set(mutator, "instance", ret);
			return ret;
		}

		public Mutator(Blockly Blockly, string[] quarkNames)
			: base(Blockly, (object)Blockly.Script.New("Blockly.Mutator", new object[] { Bridge.Script.NewArray(quarkNames) }))
		{
		}
		...
		{
			return block.Script.MutatorReconnect(connectionChild == null ? null : connectionChild.instance, block.instance, inputName);
		}
	...
	public class Connection
	{
		...
		private BlocklyScript Script;

		public Connection targetConnection { get { return Connection.Create(Blockly, instance.targetConnection); } }

		protected Connection(Blockly Blockly, object instance)
		{
			this.instance = instance;
			this.Blockly = Blockly;
			Script = Blockly.Script;
		...
		public static Connection Create(Blockly Blockly, object connection)
		{
			...
			var ret = new Connection(Blockly, connection);
		...
		{
			return Connection.Create(Blockly, instance.setCheck.call(instance, check));
		}
	...
	{
		public RenderedConnection(Blockly Blockly, object instance)
			: base(Blockly, instance)
		{
		}

		public RenderedConnection(Blockly Blockly, Block source, int type)
			: base(Blockly, null)
		{
			instance = Blockly.Script.New("Blockly.RenderedConnection", new object[] { source.instance, type });
	...
	public class Field
	{
		...
		public Field(Blockly Blockly, object instance)
		{
			this.instance = instance;
			this.Blockly = Blockly;
			Script = Blockly.Script;
		...
		public Field(Blockly blockly, string text, Func<string, object> opt_validator = null)
			: this(blockly, (object)null)
		{
		...
		/// </summary>
		[Name(false)]
		public bool EDITABLE { get { return instance.EDITABLE; } set { instance.EDITABLE = value; } }
		...
		public Func<string, string> getValidator()
		{
			...
			if ((ret == null) || (ret is DBNull))
				return null;
			return (Func<string, string>)ret.instance;
		}
		...
		public goog.math.Size getSize()
		{
			...
			if ((ret == null) || (ret is DBNull))
				return null;
			return new goog.math.Size(Script, ret);
		}
		...
		public virtual void setTooltip(Union<string, Element> newTip)
		{
	...
	public class FieldLabel : Field
	{
		...
		public FieldLabel(Blockly blockly, string text, string opt_class = null)
			: base(blockly, null)
		{
		...
		/// link to for its tooltip.</param>
		public override void setTooltip(Union<string, Element> newTip)
		{
			var element = newTip.As<Element>();
			if (element != null)
				instance.setTooltip.call(instance, element.instance);
	...
	public class FieldCheckbox : Field
	{
		...
		public FieldCheckbox(Blockly blockly, string state, Func<string, object> opt_validator = null)
			: base(blockly, null)
		{
			var func = opt_validator == null ? null : Script.NewFunc(opt_validator);
	...
	public class FieldDropdown : Field
	{
		...
		/// </param>
		public FieldDropdown(Blockly blockly, Union<string[][], Func<string[][]>> menuGenerator, Func<string, object> opt_validator = null)
			: base(blockly, null)
		{
		...
		public dynamic ForScript(string[][] a)
		{
			var b = Bridge.Script.NewArray();
			foreach (var i in a) {
				var c = Bridge.Script.NewArray();
				foreach (var j in i) {
					Bridge.Script.Push(c, j);
				}
				Bridge.Script.Push(b, c);
			}
			return b;
		}
		...
		/// </summary>
		public int CHECKMARK_OVERHANG = 25;

		/// <summary>
		/// Android can't (in 2014) display "▾", so use "▼" instead.
		/// </summary>
		public string ARROW_CHAR = "\u25BE";
	...
	public class FieldTextInput : Field
	{
		public Action<string> onFinishEditing_ {
			get {
				...
				if ((func == null) || (func is DBNull))
					return null;
				var handler = Script.Get(func, "instance");
				if (handler == null) {
					var ret = new Action<string>((str) => {
						func.call(instance, str);
					});
					Script.Set(func, "instance", ret);
				}
				return handler;
			}
			set {
		...
		/// text as an argument and returns either the accepted text, a replacement
		/// text, or null to abort the change.</param>
		public FieldTextInput(Blockly blockly, string text, Func<string, object> opt_validator = null)
			: base(blockly, null)
		{
			var func = opt_validator == null ? null : Script.NewFunc(opt_validator);
	...
	public class FieldDate : Field
	{
		...
		/// is aborted.</param>
		public FieldDate(Blockly blockly, string date, Func<string, object> opt_validator = null)
			: base(blockly, null)
		{
			var func = opt_validator == null ? null : Script.NewFunc(opt_validator);
	...
	public class FieldColour : Field
	{
		...
		/// is aborted.</param>
		public FieldColour(Blockly blockly, string colour, Func<string, object> opt_validator = null)
			: base(blockly, null)
		{
			var func = opt_validator == null ? null : Script.NewFunc(opt_validator);
		...
		/// </summary>
		public string[] COLOURS = new string[0];
		...
		{
			return new FieldColour(Blockly, instance.setColours.call(instance, colours));
		}
		...
		{
			return new FieldColour(Blockly, instance.setColumns.call(instance, columns));
		}
	}
	...
	public class FieldNumber : FieldTextInput
	{
		...
		/// text as an argument and returns either the accepted text, a replacement
		/// text, or null to abort the change.</param>
		public FieldNumber(Blockly blockly, string value, Union<string, int> opt_min,
			Union<string, int> opt_max, Union<string, int> opt_precision,
		...
		public void setConstraints(Union<string, int> min, Union<string, int> max,
			Union<string, int> precision)
		{
	...
	public class FieldAngle : FieldTextInput
	{
		...
		/// the change.</param>
		public FieldAngle(Blockly blockly, string text, Func<string, object> opt_validator = null)
			: base(blockly, null)
		{
			var func = opt_validator == null ? null : Script.NewFunc(opt_validator);
	...
	public class FieldImage : Field
	{
		...
		public FieldImage(Blockly blockly, string src, int width, int height, string opt_alt = "")
			: base(blockly, null)
		{
	...
	public class FieldVariable : Field
	{
		...
		public FieldVariable(Blockly blockly, string varname, Func<string, object> opt_validator = null)
			: base(blockly, null)
		{
			var func = opt_validator == null ? null : Script.NewFunc(opt_validator);
	...
	public class Rectangle
	{
		...
		public Rectangle(Script Script, dynamic comobj)
		{
			this.topLeft = new goog.math.Coordinate(Script, comobj.topLeft);
			this.bottomRight = new goog.math.Coordinate(Script, comobj.bottomRight);
		}
	}
	...
	public class ContextMenu
	{
		...
		{
			return block.Script.ContextMenuCallbackFactory(block.instance, xml.instance);
		}
	}
	...
	internal class FlyoutButton
	{
		...
		public FlyoutButton(Blockly Blockly, object instance)
		{
			this.instance = instance;
			this.Blockly = Blockly;
		}

		public static FlyoutButton Create(Blockly Blockly, dynamic instance)
		{
			if ((instance == null) || (instance is DBNull))
				return null;
			return new FlyoutButton(Blockly, instance);
		}

		internal Workspace getTargetWorkspace()
		{
			return WorkspaceSvg.Create(Blockly, instance.getTargetWorkspace.call(instance));
		}
	}
	...
	{
		public static string getMsg(BlocklyScript Script, string str, object opt_values)
		{
		...
		{
			public static Element createDom(BlocklyScript Script, string v, object o = null, Union<string, Element> t = null)
			{
				var element = (t == null) ? null : t.As<Element>();
				if (element != null)
					return Element.Create(Script, Script.goog_dom_createDom(v, o, element));
				else
					return Element.Create(Script, Script.goog_dom_createDom(v, o, (string)t));
			}
		}
		...
		public static class math
		{
			...
			public class Size
			{
				...
				public Size(Script Script, dynamic comobj)
				{
			...
			public class Coordinate
			{
				...
				public Coordinate(Script Script, dynamic comobj)
				{
		...
		{
			internal static bool equals(BlocklyScript Script, Array a, Array b)
			{
